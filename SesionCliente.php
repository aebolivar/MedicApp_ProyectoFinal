...
<nav class="navbar navbar-inverse">
	...
	<ul class="nav navbar-nav navbar-right">
		<li><a href="SesionCliente.php"><span class="glyphicon glyphicon-log-in"> INICIO </span></a></li>
...
<div class="footer" style="clear: both; border-top: 2px solid rgba(103,103,87,0.55); margin:20px auto; width: 80%" >
  <footer style="background-color: white">
    <figure id="logo_pie_fig" style="margin-bottom: 39px;"> <a id="logo_pie_ref" title="Inicio" href="Productos_Uno.html"><img id="logo_pie_img" src="IMAGENES/Logo.png" alt="logopie"></a>
