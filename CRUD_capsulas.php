...
<body>
	...
	<?php
		...
		if(isset($_POST["cr"])){
			...
			$sql="INSERT INTO productos_capsulas (Nombre, Precio, Direccion) VALUES (:nom, :pre, :dir)";
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
		<table style="width: 70%; margin: auto;" width="50%" border="0" align="center">
			<tr >
				...
				<td class="primera_fila">Prciónecio</td>
				<td class="primera_fila">Direc</td>
				<td class="sin">&nbsp;</td>
				<td class="sin">&nbsp;</td>
				<td class="sin">&nbsp;</td>
			</tr> 
			...
			<tr style="height:  50px;" >
			  ...
			  <td class="bot"><a href="php/BorrarPD.php?Id=<?php echo $persona->Id ?>"><input type='button' name='del' id='del' value='Borrar'></a></td>
			  <td class='bot'><a href="php/ActualizarPD.php?Id=<?php echo $persona->Id ?> & nom=<?php echo $persona->Nombre ?> & pre=<?php echo $persona->Precio ?> & dir=<?php echo $persona->Direccion ?>"><input type='button' name='up' id='up' value='Actualizar'></a></td>
			</tr>  
